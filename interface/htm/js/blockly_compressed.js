...
goog.array.filter = goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.filter) ?
    function(a, b, c) {
        ...
        for (var d = a.length,
                e = [], f = 0, g = goog.isString(a) ? a.split("") : a, h = 0; h < d; h++)
            if (h in g) {
                var k = g[h];
...
goog.array.some = goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.some) ?
    function(a, b, c) {
        ...
        for (var d = a.length,
                e = goog.isString(a) ? a.split("") : a, f = 0; f < d; f++)
...
goog.dom.getTextContent_ = function(a, b, c) {
    if (!(a.nodeName in goog.dom.TAGS_TO_IGNORE_))
        ...
        for (a = a.firstChild; a;) goog.dom.getTextContent_(a, b, c),
            a = a.nextSibling
};
...
goog.Promise.prototype.removeUnhandledRejection_ = function() {
    if (0 < goog.Promise.UNHANDLED_REJECTION_DELAY)
        for (var a = this; a && a.unhandledRejectionId_; a = a.parent_) goog.global.clearTimeout(a.unhandledRejectionId_),
...
goog.events.EventTarget.dispatchEventInternal_ = function(a, b, c) {
    ...
    var e = !0,
        f;
    if (c)
        for (var g = c.length - 1; !b.propagationStopped_ && 0 <= g; g--) f = b.currentTarget = c[g],
    ...
    if (c)
        for (g = 0; !b.propagationStopped_ && g < c.length; g++) f = b.currentTarget = c[g],
...
goog.debug.Logger.prototype.doLogRecord_ = function(a) {
    ...
    if (goog.debug.Logger.ENABLE_HIERARCHY)
        for (var b = this; b;) b.callPublish_(a),
            b = b.getParent();
    else
        for (var b = 0,
...
Blockly.Connection.lastConnectionInRow_ = function(a, b) {
    for (var c = a,
            d; d = Blockly.Connection.singleConnection_(c, b);)
...
Blockly.Field.prototype.init = function() {
    this.fieldGroup_ || (this.fieldGroup_ = Blockly.createSvgElement("g", {},
        ...
        this.fieldGroup_), this.updateEditable(), this.sourceBlock_.getSvgRoot().appendChild(this.fieldGroup_), this.mouseUpWrapper_ = Blockly.bindEventWithChecks_(this.fieldGroup_, "mouseup", this, this.onMouseUp_), this.updateTextNode_())
};
...
Blockly.Xml.domToBlockHeadless_ = function(a, b) {
    ...
    for (var e = a.getAttribute("id"), c = b.newBlock(d, e), f = null, e = 0, g; g = a.childNodes[e]; e++)
        if (3 != g.nodeType) {
            for (var h = f = null,
                    k = 0,
                    m; m = g.childNodes[k]; k++) 1 == m.nodeType && ("block" == m.nodeName.toLowerCase() ? f = m : "shadow" == m.nodeName.toLowerCase() && (h = m));
            !f && h && (f = h);
...
Blockly.WorkspaceSvg.prototype.traceOn = function(a) {
    ...
    a && (this.traceWrapper_ = Blockly.bindEventWithChecks_(this.svgBlockCanvas_, "blocklySelectChange", this,
        function() {
            this.traceOn_ = !1
        }))
};
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function(a) {
    ...
    if (!this.options.readOnly && !this.isFlyout) {
        ...
        if (this.options.collapse) {
            for (var h = g = !1,
                    k = 0; k < e.length; k++)
                for (var m = e[k]; m;) m.isCollapsed() ? g = !0 : h = !0,
                    m = m.getNextBlock();
            var p = function(a) {
                    for (var b = 0,
                            c = 0; c < e.length; c++)
                        for (var d = e[c]; d;) setTimeout(d.setCollapsed.bind(d, a), b),
                            d = d.getNextBlock(),
                            b += 10
                },
                h = {
...
Blockly.Warning.prototype.setVisible = function(a) {
    if (a != this.isVisible())
        if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "warningOpen", !a, a)), a) {
            ...
            if (this.block_.RTL)
                for (var b = a.getBBox().width, c = 0, d; d = a.childNodes[c]; c++) d.setAttribute("text-anchor", "end"),
...
Blockly.Block.prototype.setConnectionsHidden = function(a) {
    if (!a && this.isCollapsed()) {
        ...
        for (var c = this.getConnections_(!0), d = 0; b = c[d]; d++) b.setHidden(a),
...
Blockly.Block.prototype.moveInputBefore = function(a, b) {
    if (a != b) {
        for (var c = -1,
                d = b ? -1 : this.inputList.length, e = 0, f; f = this.inputList[e]; e++)
            if (f.name == a) {
                if (c = e, -1 != d) break
...
Blockly.ContextMenu.blockHelpOption = function(a) { 
    return { enabled: !("function" == typeof a.helpUrl ? !a.helpUrl() : !a.helpUrl), text: "帮助", callback: function() { a.showHelp_() } } 
};
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
    ...
    if (c) this.setWarningText.pid_[c] && (clearTimeout(this.setWarningText.pid_[c]), delete this.setWarningText.pid_[c]);
        ...
        for (var d in this.setWarningText.pid_) clearTimeout(this.setWarningText.pid_[d]),
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
    ...
    for (var d = 0,
            ...
            h = !1,
            k = void 0,
            m = this.getInputsInline() && !this.isCollapsed(), p = 0, l; l = b[p]; p++)
        if (l.isVisible()) {
            var n;
            m && k && k != Blockly.NEXT_STATEMENT && l.type != Blockly.NEXT_STATEMENT ? n = c[c.length - 1] : (k = l.type, n = [], n.type = m && l.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : l.type, n.height = 0, c.push(n));
            n.push(l);
            ...
            n.type != Blockly.BlockSvg.INLINE && (n.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, l.fieldWidth)) : (n.type == Blockly.INPUT_VALUE ? f = !0 : n.type == Blockly.DUMMY_INPUT && (h = !0), d = Math.max(d, l.fieldWidth)))
        }
    for (a = 0; n = c[a]; a++)
...
Blockly.FieldTextInput.prototype.showEditor_ = function(a) {
    ...
    a = a || !1;
    if (!a && (goog.userAgent.MOBILE || goog.userAgent.ANDROID || goog.userAgent.IPAD)) a = window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE, this.text_),
        ...
        c.onKeyPressWrapper_ = Blockly.bindEventWithChecks_(c, "keypress", this, this.onHtmlInputChange_);
...
Blockly.Variables.createVariable = function(a) {
    copyObj = a;
    //Cef.JS2C("createVariable()");
    console.log("createVariable()");
    //断开中转到net,返回null
    return null
};
Blockly.Variables.createVariableC2JS = function(a) {
    copyObj.createVariable(a);
};
/* 
Blockly.Variables.createVariable = function(a) {
    for (;;) {
        var b = Blockly.Variables.promptName(Blockly.Msg.NEW_VARIABLE_TITLE, "");
        if (b) if ( - 1 != a.variableIndexOf(b)) window.alert(Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace("%1", b.toLowerCase()));
        else {
            a.createVariable(b);
            break
        } else {
...
Blockly.FieldVariable.prototype.classValidator = function(a) {
    ...
    if (a == Blockly.Msg.DELETE_VARIABLE.replace("%1", this.getText())) return b.deleteVariable(this.getText()),
        null
};
...
Blockly.Flyout.prototype.show = function(a) {
    ...
    for (var b = [], c = [], d = this.permanentlyDisabled_.length = 0, e; e = a[d]; d++)
        if (e.tagName) {
            ...
            "BLOCK" == f ? (f = Blockly.Xml.domToBlock(e, this.workspace_), f.disabled && this.permanentlyDisabled_.push(f), b.push({
                type: "block",
                block: f
...
Blockly.Flyout.prototype.layout_ = function(a, b) {
    ...
    for (var e = 0,
        ...
        } else "button" == f.type && (f = f.button, g = f.createDom(), f.moveTo(d, c), f.show(), Blockly.bindEventWithChecks_(g, "mouseup", f, f.onMouseUp), this.buttons_.push(f), this.horizontalLayout_ ? d += f.width + b[e] : c += f.height + b[e])
};
...
Blockly.bindEventWithChecks_ = function(a, b, c, d, e) {
    var f = !1,
        g = function(a) {
            ...
            for (var g = 0,
                    h; h = a[g]; g++)
                if (!b || Blockly.Touch.shouldHandleEvent(h)) Blockly.Touch.setClientFromTouch(h),
                    c ? d.call(c, h) : d(h),
                    f = !0
        };
    ...
    if (b in Blockly.Touch.TOUCH_MAP)
        for (var k = function(a) {
                ...
                m = 0, p; p = Blockly.Touch.TOUCH_MAP[b][m]; m++) a.addEventListener(p, k, !1),
            h.push([a, p, k]);
    return h
};
