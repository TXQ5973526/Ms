:mod:`micropython` -- 访问和控制MicroPython内部构件
==============================================================

.. module:: micropython
   :synopsis: 访问和控制MicroPython 内部构件
...
.. function:: const(expr)
   ...
   `const` 函数是由MicroPython解析器直接识别的，并作为 `micropython` 模块的一部分提供，因此可通过以上模式编写在CPython和MicroPython下运行的脚本。
